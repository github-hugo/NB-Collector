...
public class NBConstant {

	// please replace the IP and Port, when you use the demo.
	public static final String BASE_URL = PropertyUtils.getPropertyValue("BASE_URL");

	// please replace the appId and secret, when you use the demo.
	public static final String APPID = PropertyUtils.getPropertyValue("APPID");
	public static final String SECRET = PropertyUtils.getPropertyValue("SECRET");
	 ...
	 */
	public static final String CALLBACK_BASE_URL = PropertyUtils.getPropertyValue("CALLBACK_BASE_URL");

	/*
	 * complete callback url锛� please replace uri, when you use the demo.
	 */
	...
	public static String SELFCERTPATH = PropertyUtils.getPropertyValue("SELFCERTPATH");
	// public static String SELFCERTPATH = "/src/main/resources/cert/tmp.p12";
	public static String TRUSTCAPATH = PropertyUtils.getPropertyValue("TRUSTCAPATH");

	// Password of certificates.IoM@1234
	public static String SELFCERTPWD = PropertyUtils.getPropertyValue("SELFCERTPWD");
	// public static String SELFCERTPWD = "Nhb@2018";
	public static String TRUSTCAPWD = PropertyUtils.getPropertyValue("TRUSTCAPWD");

	// When use xinhongbo certificates.
	// public static String SELFCERTPWD = "Nhb@NB-IoT";
	...
	/*
	 * Device Management: 1. REGISTER_DEVICE 2. MODIFY_DEVICE_INFO 3.
	 * QUERY_DEVICE_ACTIVATION_STATUS 4. DELETE_DEVICE 5.
	...
	/*
	 * Signaling Delivery锛� 1. POST_ASYN_CMD 2. QUERY_DEVICE_CMD 3.
	...
	public static final String CREATE_DEVICECMD_CANCEL_TASK = BASE_URL
